...
//set texture
void ListButton::set_texture(std::string PATH) {
...
*/
ListButton::ListButton(Shader* _shader, WINDOW* _windowobj, double _posx, double _posy, double _scale, std::string PATH) {
...
*/
void ListButton::accept_input(glm::vec4 point) {
