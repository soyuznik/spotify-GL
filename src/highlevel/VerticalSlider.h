...
public:
	...
	double dscale;
	// dot texture
	TEXTURE dotTexture = TEXTURE("Resources/textures/blacker_gray.png");
	...
	VerticalSlider(Shader* shader, WINDOW* windowobj, const char* path, double posx, double posy, double scale); // slider constructor
	...
	VertexArrayObject VAO = VertexArrayObject("Resources/vertices/square_higher_slider.buf");
